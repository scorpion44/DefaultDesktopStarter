...
Protected Module Diff
	...
	#tag Method, Flags = &h1
		Protected Sub RunUnitTests()
		  debug.log(CurrentMethodName + " Self Test...")
		  ...
		  If True Then
		    ...
		    debug.log("all-changes test passed.")
		  ...
		  If True Then
		    ...
		    debug.log("all-same test passed.")
		  ...
		  If True Then
		    ...
		    debug.log("repro20020920 test passed.")
		  End If
		  ...
		  If True Then
		    ...
		    debug.log("repro20030207 test passed.")
		  End If
		  ...
		  If True Then
		    ...
		    debug.log("repro20030409 test passed.")
		  End If
		  ...
		  If True Then
		    ...
		    debug.log("some-changes test passed.")
